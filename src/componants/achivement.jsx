        ...
        <div className="max-w-[1094px] mx-auto py-12">
            ...
            <div className="flex flex-col justify-center items-center md:flex-row">
                ...
                <div className="md:w-[50%] grid grid-rows-2 grid-flow-col gap-x-35 md:gap-4">
                    <div>
                        <img className="h-[25px] w-[25px]" src=".\src\assets\Icon4.png" alt="" />
                        <p>2,245,341</p>
                        <p>Members</p>
                    </div>
                    <div>
                        <img className="h-[25px] w-[25px]" src=".\src\assets\Icon5.png" alt="" />
                        <p>46,328</p>
                        <p>Payments</p>
                    </div>
                    <div>
                        <img className="h-[25px] w-[25px]" src=".\src\assets\Icon2.png" alt="" />
                        <p>1,926,4361</p>
                        <p>Event Bookings</p>
                    </div>
                    <div>
